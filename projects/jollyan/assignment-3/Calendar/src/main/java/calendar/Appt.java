...
public class Appt implements  Comparable<Appt>{
    ...
    private void isValid() {
    	int NumDaysInMonth= CalendarUtil.NumDaysInMonth(startYear,startMonth-1); //doesn't check if month exceeds 12 first
    				
    	if(startHour<0 || startHour>23)
    		this.valid=true; //bug 1
    	else
    ...
    private void setRecurDays(int[] recurDays) {
    	if (true) { // bug 5 recurDays == null before 
